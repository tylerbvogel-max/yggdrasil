export default function CompliancePage() {
  ...
  const metricsItems: ComplianceItem[] = [
    ...
    { id: 'MET-2', title: 'Validity & Reliability', status: 'partial',
      detail: 'Blind A/B framework validates model quality. Scoring baselines with percentile distributions provide statistical characterization. Eval score disaggregation by answer mode enables cross-mode comparison. Missing: formal confidence intervals, cross-validation protocol, robustness testing.',
    ...
    { id: 'MET-4', title: 'Fairness & Bias Assessment', status: 'partial',
      detail: 'Compliance Audit page computes department coverage analysis with coefficient of variation (CV) imbalance detection, per-department neuron counts/invocations/utility, and eval score disaggregation by answer mode. CV > 0.5 flags imbalanced coverage. Missing: demographic fairness analysis (single-author system), formal remediation plan for coverage gaps.',
