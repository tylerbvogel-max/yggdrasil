export default function Aiuc1Page() {
  ...
  const safetyItems = [
    ...
    { id: 'C008', title: 'Monitor AI Risk Categories', status: 'partial' as const,
      detail: 'Blind A/B evaluation tracks quality over time. Performance page shows cost and token trends. Missing: automated drift detection, scoring distribution monitoring, alerting on anomalies.' },
